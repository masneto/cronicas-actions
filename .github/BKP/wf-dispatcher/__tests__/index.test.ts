...
describe("Workflow Dispatcher Action", () => {
  ...
  //   expect(mockCopyFile).toHaveBeenCalledWith("source.yml", ".github/workflows/source.yml");
  //   expect(mockExec).toHaveBeenNthCalledWith(6, "git", ["fetch", "origin"]);
  //   expect(mockExec).toHaveBeenNthCalledWith(7, "git", ["checkout", "-b", "main-temp", "origin/main"]);
  ...
  //   expect(mockExec).toHaveBeenNthCalledWith(11, "git", ["commit", "-m", "add workflow source.yml"]);
  //   expect(mockExec).toHaveBeenNthCalledWith(12, "git", ["push", "origin", "main-temp", "--force"]);
  //   expect(mockCreateWorkflowDispatch).toHaveBeenCalledWith({
  //     owner: "masneto",
  //     repo: "cronicas-monitor",
  //     workflow_id: "source.yml",
  //     ref: "main-temp",
  //     inputs: { foo: "bar" },
  //   });
